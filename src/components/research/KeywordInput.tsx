...
export default function KeywordInput({ onSubmit, isDisabled = false }: KeywordInputProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6 max-w-full">
      <div className="relative">
        <input
          ...
          disabled={isDisabled}
          className="w-full px-4 py-3 pl-12 pr-24 bg-zinc-800 border border-zinc-700 
        ...
        <button
          ...
          className="absolute inset-y-2 right-2 px-3 sm:px-4 bg-emerald-500 
        ...
        >
          {isDisabled ? (
            ...
            <>
              <span className="hidden sm:inline">Begin Research</span>
