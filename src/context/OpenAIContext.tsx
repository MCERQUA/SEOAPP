...
export function OpenAIProvider({ children }: { children: React.ReactNode }) {
  ...
  const generateArticle = async (content: string) => {
    ...
    try {
      ...
      const prompt = `Generate a comprehensive, in-depth article of 4000-5000 words based on our research:
...
Generate the article now, ensuring comprehensive coverage of all research points.`;
      ...
      let response;
      let attempts = 0;
      const maxAttempts = 180;  // Increased timeout for longer content generation
