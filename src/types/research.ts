...
Format your response as a structured outline with clear hierarchy and explanations.`,
  ...
  keywords: (keyword: string) => `Act as a Keyword Research Specialist. Analyze keyword landscape for "${keyword}". Provide:
- Related and semantically connected keywords
- Long-tail keyword opportunities
- Search volume and difficulty analysis
- User search pattern insights
- Potential content expansion ideas
- Keyword clustering recommendations

Format your response with clear headings and bullet points. Include actionable keyword strategies.`,

  userContent: (keyword: string) => `Act as a User-Centric Content Analyst. Evaluate user-generated content for "${keyword}". Research and provide:
- Common user questions and discussions
- Pain points and challenges expressed
- Existing content gaps
- User sentiment and language
- Community-driven insights
- Potential content personalization strategies

Format your response with clear headings and bullet points. Focus on authentic user perspectives.`
};
